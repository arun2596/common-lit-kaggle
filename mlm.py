...
mlm_data.to_csv('data/mlm_data/mlm_data.csv', index=False)

mlm_data_val = test[['excerpt']]
mlm_data_val = mlm_data_val.rename(columns={'excerpt':'text'})
mlm_data_val.to_csv('data/mlm_data/mlm_data_val.csv', index=False)
...
class TrainConfig:
    train_file= 'data/mlm_data/mlm_data.csv'
    validation_file = 'data/mlm_data/mlm_data.csv'
